...
<div class="bodyidex">
  ...
  <div class="contenedorpanel">
    ...
    <table width="370" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#cccccc" bgcolor="#ffffff">
        <tr>
          <td width="450" height="35"><b>Nombre de la categoria</b></td>
          <td width="131">&nbsp;</td>
        </tr>
       <?php do { ?> <tr>
          ...
          <td height="40"><?php $programa=strtolower($row_Recordset1["categoria"]);
		  			echo utf8_encode(ucwords($programa));
		  ?></td>
          <td align="center"><a href="eliminando.php?id_categoria=<?php echo $row_Recordset1["id_categoria"];?>&amp;id_administrador=<?php echo $_GET["id_administrador"]; ?>" onclick="return confirm('¿Esta seguro que desea  eliminar este programa? ESTA ACCION NO PUEDE DESHACERSE');"><img src="../../images/btn/eliminar.gif" alt="" border="0" /></a><a href="editando.php?id_categoria=<?php echo $row_Recordset1["id_categoria"];?>&id_administrador=<?php echo $_GET["id_administrador"]; ?>"></a></td>
