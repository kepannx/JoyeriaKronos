...
<div class="bodyidex">
  ...
  <div class="contenedorpanel">
    ...
    <br />
    <br />
   <div class="contenedorbtnpanel" align="center"><a href="ingresar.php?id_administrador=<?php echo  $check["id_administrador"]; ?>"><img src="../../images/btn/ingresar_categoria.gif" / border="0"></a></div>
  <div class="contenedorbtnpanel" align="center"><a href="editar.php?id_administrador=<?php echo  $check["id_administrador"]; ?>"><img src="../../images/btn/editar_categoria.gif" alt="" / border="0" /></a></div>
  <div class="contenedorbtnpanel" align="center"><a href="eliminar.php?id_administrador=<?php echo  $check["id_administrador"]; ?>"><img src="../../images/btn/eliminar_categoria.gif" alt="" / border="0" /></a></div>
