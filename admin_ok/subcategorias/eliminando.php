...
<div class="bodyidex">
  ...
  <div class="contenedorpanel">
    ...
    <br /><div align="center"><?php 
		...
		$sqlingreso="DELETE  FROM subcategoria WHERE id_subcategoria='$id_subcategoria'";
		if(@$queryingreso=mysql_db_query($database_joyeria,$sqlingreso,$joyeria)){
			
			$flag=mysql_insert_id($joyeria);
			echo "El subcategoria se  a eliminado con exito";
			
			}	
			else{
				
				echo "No se pudo eliminar el subcategoria, intentelo de nuevo<br>".mysql_error();
				}      
