...
<div class="bodyidex">
  ...
  <div class="contenedorpanel">
    ...
    <div class="contenedorfrm">
   	  <div id="contenidoform">Nombre de la subCategoria</div>
   	  <span id="sprytextfield2">
   	  <label>
   	    <input type="text" name="subcategoria" id="subcategoria" />
 	    </label>
   	  <span class="textfieldRequiredMsg"><font color="#000000">El nombre de la subcategoria es necesaria</font></span></span> </div>
