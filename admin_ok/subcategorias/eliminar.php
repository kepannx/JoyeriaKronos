...
$query_Recordset1 = "SELECT * FROM subcategoria";
...
<div class="bodyidex">
  ...
  <div class="contenedorpanel">
    ...
    <table width="370" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#cccccc" bgcolor="#ffffff">
        <tr>
          <td width="450" height="35"><b>Nombre de la subsubcategoria</b></td>
          <td width="131">&nbsp;</td>
        </tr>
       <?php do { ?> <tr>
          ...
          <td height="40"><?php $programa=strtolower($row_Recordset1["subcategoria"]);
		  			echo utf8_encode(ucwords($programa));
		  ?></td>
          <td align="center"><a href="eliminando.php?id_subcategoria=<?php echo $row_Recordset1["id_subcategoria"];?>&amp;id_administrador=<?php echo $_GET["id_administrador"]; ?>" onclick="return confirm('¿Esta seguro que desea  eliminar este programa? ESTA ACCION NO PUEDE DESHACERSE');"><img src="../../images/btn/eliminar.gif" alt="" border="0" /></a></td>
