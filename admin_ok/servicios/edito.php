...
<div class="bodyidex">
  ...
  <div class="contenedorpanel">
    ...
    <?php 
		...
		$sqlingreso="UPDATE servicios SET servicio='$servicio',  descripcion='$descripcion' WHERE id_servicio='$id_servicio'";
		if(@$queryingreso=mysql_db_query($database_joyeria,$sqlingreso,$joyeria)){
			
			$flag=mysql_insert_id($joyeria);
			echo "El servicio se  a editado con exito";
			
			}	
			else{
				
				echo "No se pudo editar el servicio, intentelo de nuevo<br>".mysql_error();
				}      
