  ...
  <div class="contenedorpanel">
    ...
    <table width="370" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#cccccc" bgcolor="#ffffff">
       ...
       <?php do { ?> <tr>
		  ...
		  ?></td>
          <td align="center"><a href="editando.php?id_categoria=<?php echo $row_Recordset1["id_categoria"];?>&id_administrador=<?php echo $_GET["id_administrador"]; ?>"><img src="../../images/btn/editar.gif" border="0" /></a></td>
