...
<div class="bodyidex">
  ...
  <div class="contenedorpanel">
    ...
    <br /><div align="center"><?php 
		...
		$sqlingreso="DELETE  FROM categorias WHERE id_categoria='$id_categoria'";
		if(@$queryingreso=mysql_db_query($database_joyeria,$sqlingreso,$joyeria)){
			
			$flag=mysql_insert_id($joyeria);
			echo "El categoria se  a eliminado con exito";
			
			}	
			else{
				
				echo "No se pudo eliminar el categoria, intentelo de nuevo<br>".mysql_error();
				}      
