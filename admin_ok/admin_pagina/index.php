...
<div class="bodyidex">
  ...
  <div class="contenedorpanel">
    	Panel Admin Pagina<font color="#CC0000"><b><?php echo $check["nombre"];?></b></font><br />
    <br />
    <br />
   <div class="contenedorbtnpanel" align="center"><a href="promociones/index.php?id_administrador=<?php echo  $check["id_administrador"]; ?>"><img src="../../images/btn/promociones.gif" / border="0"></a></div>
   <div class="contenedorbtnpanel" align="center"></div>
   <div class="contenedorbtnpanel" align="center"><a href="puntosventa/index.php?id_administrador=<?php echo  $check["id_administrador"]; ?>"><img src="../../images/btn/puntos_de_venta.gif" alt="" / border="0" /></a></div>
  <div class="contenedorbtnpanel" align="center"></div>
