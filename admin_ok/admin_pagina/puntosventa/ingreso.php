...
<div class="bodyidex">
  ...
  <div class="contenedorpanel">
    ...
    <br />
    <br />
    <form action="../../categorias/ingreso.php" method="post">
    <div class="contenedorfrm" align="center"><?php 
      ...
      $punto=$_POST["punto"];
		...
		$sqlingreso="INSERT INTO puntosventa SET punto='$punto'";
		if(@$queryingreso=mysql_db_query($database_joyeria,$sqlingreso,$joyeria)){
			
		
			echo "El punto se ingreso con exito";
			}	
			else{
				
				echo "No se pudo ingresar el punto intentelo de nuevo<br>".mysql_error();
				}      
