...
header ("Location: .$error"); 
		...
		echo $id_punto=$_GET["id_punto"];
		
 $sql="SELECT * FROM puntosventa WHERE id_punto='$id_punto'";
@$query=mysql_db_query($database_joyeria,$sql,$joyeria);
...
<div class="bodyidex">
  ...
  <div class="contenedorpanel">
    ...
    <div class="contenedorfrm">
   	  ...
   	  <label>
   	    <input name="punto" type="text" id="punto" value="<?php echo $categoria["punto"]; ?>" />
 	    </label>
   	  <span class="textfieldRequiredMsg"><font color="#000000">El nombre de la categoria es necesaria</font></span></span> 
   	  <input name="id_punto" type="hidden" id="id_punto" value="<?php echo $_GET["id_punto"];?>" />
    </div>
