...
$query_Recordset1 = "SELECT * FROM puntosventa";
...
<div class="bodyidex">
  ...
  <div class="contenedorpanel">
    ...
    <table width="370" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#cccccc" bgcolor="#ffffff">
        <tr>
          <td width="450" height="35"><b>Nombre del punto de venta</b></td>
          <td width="131">&nbsp;</td>
        </tr>
       <?php do { ?> <tr>
          ...
          <td height="40"><?php $programa=strtolower($row_Recordset1["punto"]);
		  			echo utf8_encode(ucwords($programa));
		  ?></td>
          <td align="center"><a href="editando.php?id_punto=<?php echo $row_Recordset1["id_punto"];?>&amp;id_administrador=<?php echo $_GET["id_administrador"]; ?>"><img src="../../../images/btn/editar.gif" border="0" /></a></td>
