...
<div class="contenedorcuerpo">
	...
	?>
            <div id="contenedorbtn2" align="center"><a href="ver_servicio.php?id_servicio=<?php echo $categoria["id_servicio"];?>"><font color="#333333"><?php echo $categoria["servicio"];?></font></a></div>
            <?php } ?>
