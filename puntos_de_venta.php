...
<div class="contenedorcuerpo">
    ...
    <div class="contenedorindexbase">
    	<div class="contenedorproductoindex">
          ...
          <?php $sql="SELECT * FROM puntosventa ";
		   @$query=mysql_db_query($database_joyeria,$sql,$joyeria);
		while($puntos=mysql_fetch_array($query)){?>
          
          <div id="titulo003" align="center"><font color="#333333"><?php echo $puntos["punto"]; ?> <?php echo $puntos["datos"]; ?></font></div>
          <br />
          <br />
          <br />
           <?php } ?>
           <div align="center"><font color="#990000" size="+1">Linea Única(57-4)448 81 85</font> </div>
