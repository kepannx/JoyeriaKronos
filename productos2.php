...
<div class="contenedorsubpro">
	...
	?>
    <div id="contenedorbtn1" align="center"><a href="ver_categoria.php?id_categoria=<?php echo $categoria["id_categoria"];?>"><font color="#333333"><?php echo $categoria["categoria"];?></font></a></div>
    <?php } ?>
</div>
    	</div>
    </div>
