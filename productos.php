...
<div class="contenedorcuerpo">
	...
	?>
            <div id="contenedorbtn2" align="center"><a href="ver_subproducto.php?id_subcategoria=<?php echo $categoria["id_subcategoria"];?>"><font color="#333333"><?php echo $categoria["subcategoria"];?></font></a></div>
            <?php } ?>
          </div>
    	</div>
    </div>
